...
-- Comando para Dar Restart no Banco
...
/*drop table FILTRO_BUILD;*/

insert into recomendacoes(preco,Marca,Categoria) values(0.00,null,'asccdsa');
...
INSERT INTO FILTRO_BUILD (preco, distribuidora, categoria, descricao , link,idRecomendacoes,   gabinete,ram,placa_mae,placa_video,fonte,processador,hd,ssd) 
VALUES
(3599.00, 'Pichau', 'Computador', 'Computador Pichau Home, AMD Ryzen 7 8700G 16GB DDR5 SSD 240GB' ,'https://www.pichau.com.br/computador-pichau-home-amd-ryzen-7-8700g-16gb-ddr5-ssd-240gb-46046',1     ,  'Aigo Darkflash DK100','Pichau Velvet 16GB','Asus Prime 620M-K',null,'TGT Tomahowk T3 W600','Ryzen 7 8700G',null,'TGT Seal ST 240 GB');/*,
