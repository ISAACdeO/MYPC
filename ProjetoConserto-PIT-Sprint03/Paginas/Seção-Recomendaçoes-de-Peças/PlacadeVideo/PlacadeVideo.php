...
<head>
    ...
    <link rel="stylesheet" href="PlacadeVideo.css">
</head>
<body>
    <header>
        <div class="conteiner-1">
            <h1>Placas Mãe</h1>
            <h2>Aqui você encontra as melhores placas mãe e seu site para comprar!</h2>
        </div>
    </header>
    ...
    $sql = "SELECT preco, marca, descricao, link FROM Filtro_PlacadeVideo";
